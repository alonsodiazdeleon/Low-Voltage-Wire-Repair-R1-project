...
-- Optional R1 pilot: uncomment ONE line below (default = all models/programs that pass other filters).
-- Validated: v_vehicle_model LIKE 'R1%'. Alt: v_veh_program LIKE 'R1%'.
--
...
and s.sr_completed_date >= '2026-01-01'
  -- Pilot R1: and v_vehicle_model like 'R1%'
  -- Alt pilot: and v_veh_program like 'R1%'
;
